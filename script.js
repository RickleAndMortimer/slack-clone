...
function makeMessageHTML(username, msg, time) {
    let item = document.createElement('li');
    item.innerHTML = `
    			<p class="x">${(new Date(time)).toLocaleTimeString('en-US')}</p>
...
socket.on('chat message', function(msg) {
    let item = makeMessageHTML(msg.username, msg.message, msg.time);
